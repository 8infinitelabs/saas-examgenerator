...
const PaymentMethodFormHandler = ({ setPaymentMethod, buttonText, disabled }: any) => {
  ...
  const getPaymentMethod = async (event: any) => {
...
export const PaymentMethodForm = ({ setPaymentMethod, buttonText, disabled, billingDetails }: any) => {
