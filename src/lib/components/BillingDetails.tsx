...
export const BillingDetails = (
  { setBillingDetailsObject, buttonText, disabled, currentBillingDetails }:
  {
    setBillingDetailsObject: any,
    buttonText: string,
    disabled: boolean,
  ...
  return (
    <Stack spacing={3}>
      <Grid container direction="row" justifyContent="center" alignItems="center">
        <Grid item md={8}>
          <Box p={2}>
            ...
            <VisitorAPIComponents projectId={""} handleCountryChange={(countryObj: any) => {
              if (countryObj !== null) {
                setBillingDetails(prevState => ({
                  ...prevState,
                  address: {
      ...
      <Grid container direction="row" justifyContent="center" alignItems="center">
        <Button variant="contained" disabled={disabled} onClick={() => setBillingDetailsObject(billingDetails)}>{buttonText}</Button>
      </Grid>
    </Stack>
  )
}
